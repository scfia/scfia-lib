...
impl Ast for BVOrExpression {
    fn get_z3_ast(&self) -> Z3_ast {
        self.z3_ast
    }
}

impl ActiveAst for BVOrExpression {
...
impl BitVector for BVOrExpression {}

impl Expression for BVOrExpression {}

impl BitVectorExpression for BVOrExpression {}

impl Drop for BVOrExpression {
    fn drop(&mut self) {
        // Retire expression, maintain z3 ast refcount
        let retired_expression = Rc::new(RefCell::new(RetiredBVOrExpression {
            _id: self.id,
...
impl Ast for RetiredBVOrExpression {
    fn get_z3_ast(&self) -> Z3_ast {
        self.z3_ast
    }
}
