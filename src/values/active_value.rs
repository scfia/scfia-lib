...
impl<SC: ScfiaComposition> ActiveValueInner<SC> {
    ...
    pub fn is_concrete(&self) -> bool {
        matches!(self.expression, ActiveExpression::BoolConcrete(_) | ActiveExpression::BVConcrete(_))
    }
    ...
    pub(crate) fn clone_to_stdlib(
        ...
        for (inherited_value_id, inherited_value) in &self.inherited_asts {
            ...
            cloned_value
                ...
                .unwrap()
                .inherited_asts
                .insert(*inherited_value_id, cloned_inherited_value);
        }
        ...
        for (discovered_value_id, discovered_value) in &self.discovered_asts {
            ...
            cloned_value
                ...
                .unwrap()
                .discovered_asts
                .insert(*discovered_value_id, Rc::downgrade(&cloned_discovered_value));
        }
